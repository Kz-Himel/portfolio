    ...
    <MainLayout>
      <div className="pt-28 pb-20 px-6 min-h-screen relative">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {["All", "Next.js", "React", "Firebase", "Tailwind CSS"].map(
              (tag) => (
                <button
                  key={tag}
                ...
                <div className="relative h-44 bg-gradient-to-br from-accent/10 via-secondary to-purple-500/10">
                  {project.image ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span
                        className="text-5xl font-bold text-white/8"
                ...
                <div className="p-5 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {project.tags.slice(0, 3).map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-0.5 rounded-full text-xs text-accent bg-accent/10 border border-accent/15"
                      >
                        {tag}
                      </span>
                    ))}
